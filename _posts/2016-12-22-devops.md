...
说明：
以下源码分析基于kubernetes v1.5.1版本（目前的最新版本，released 8 days ago），与其他版本不一定一致。
kubernetes v1.5.1版本Release：
https://github.com/kubernetes/kubernetes/archive/v1.5.1.tar.gz
